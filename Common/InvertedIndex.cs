...
namespace Common
{
    public class InvertedIndex
    {
        ...
        List<UInt64> GetRangeNumberKeys(string token, List<string> errors = null)
        {
            ...
            {
                errors.Add(string.Format("could not parse hexadecimal numbers within '{0}'", token));
        ...
        /// <param name="errors">Place to add error messages</param>
        /// <returns>match set</returns>
        public IMatchSet RangeMatches(string token, List<string> errors = null)
        {
            string[] parts = token.Substring(1).Split('-');
            if (token.LastIndexOf("#") != 0 || parts.Count() != 2)
            {
            ...
            IMatchSet m = new RangeMatchSet(new EntryId(n1), new EntryId(n2));
        ...
        /// <param name="errors">Place to add error messages</param>
        /// <returns>Match set</returns>
        public IMatchSet Matches(string token, List<string> errors = null)
        {
